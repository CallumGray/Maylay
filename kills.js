...
palettes = [["#fe3a3a", "#fe7f7f", "#bb2828"], ["#fa5d36", "#ffaa7a", "#d04703"], ["#fff508", "#fcfc8d", "#b9b91c"], ["#08fb08", "#89fe89", "#299f29"], ["#00bdf9", "#77ffff", "#009999"], ["#4040ff", "#8787fc", "#2d2da2"], ["#813ffc", "#ac82ff", "#5b2293"], ["#fa36fa", "#fa7afa", "#990099"], ["#9e9e9e", "#FFFFFF", "#595959"]];
...
function trajectoryObject() {
    ...
    this.zdiAngle = 0;
    this.curHitbox = Object.create(chars.Fx.neutralSpecial.id0);
...
function readQueryString() {
    ...
    if (queryExist) {
        ...
        if (GetQueryStringParams("tt")) {
            ...
            $("#labelBox0").css({
                "opacity": GetQueryStringParams("to"),
                "width": GetQueryStringParams("tw"),
                "height": GetQueryStringParams("th"),
                "top": titleY * disMagnification,
                "left": titleX * disMagnification
            });
            labelBoxClick(0);
            labelBoxDrag(0);
            labelBoxResize(0);
    ...
    $(".id").click(function() {
        ...
        if ($("#" + id4 + "stats").length > 0) {
            ...
            if (hb.angle == 361) {
                ...
                $("#miniAngle").css({
                    "background-image": "url(assets/trajectory/sakurai.png)",
                    "left": "120px"
                });
            } else {
                $("#miniAngle").css({
...
var colourChange = function(id) {
    ...
    $(".colourselectReal").click(function() {
        ...
        $("#start" + id).css({
            "fill": palettes[newp][0],
            "stroke": palettes[newp][0]
        });
        $(".fP" + id).css({
            "fill": palettes[newp][0],
            "stroke": palettes[newp][0]
        ...
        $(".fPK" + id).css({
            "fill": palettes[newp][2],
            "stroke": palettes[newp][2]
        });
        $(".fPnH" + id).css({
            "fill": palettes[newp][1],
            "stroke": palettes[newp][1]
        });
...
function drawTrajectory(n, onlyDrawWhenUnfrozen, waitTillFinish) {
    ...
    if (t["t" + n].curHitbox.article)
        damageunstaled = damagestaled;
...
function setPosInfoOffset(id) {
    ...
    $(".framePosInfoBox").css({
        "top": frameposy + 5,
        "left": (frameposx + 20),
        "border": "2px solid " + palettes[t["t" + id].palette][0]
    });
}
